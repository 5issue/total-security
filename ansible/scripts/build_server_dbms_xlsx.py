...
출력: server_dbms_result.xlsx (시트: 서버, DBMS, 인증_인가) — claude_code_handoff_spec.md 4.2/4.3절 컬럼 포맷
"""
import argparse
import json
import sys
...
# U-62는 2026-09-23 제외 근거 불완전 확인 후 roles/file_permission/tasks/main.yml에
