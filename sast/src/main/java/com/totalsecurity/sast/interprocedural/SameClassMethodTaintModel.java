...
/** Exact call-occurrence semantics derived from completed same-class summaries. */
public final class SameClassMethodTaintModel implements MethodTaintModel {
    public static final String ID = "SAME_CLASS_METHOD_SUMMARY";
    private final Map<MethodCallExpression, SameClassMethodSummary> calls;

    public SameClassMethodTaintModel(Map<MethodCallExpression, SameClassMethodSummary> calls) {
