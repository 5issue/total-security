...
public final class JdbcStatementSqlSinkRule implements SinkRule {
    public static final String ID = "JDBC_STATEMENT_SQL";
    private static final String RECEIVER = "java.sql.Statement";
    private static final Set<String> METHODS = Set.of("execute", "executeQuery", "executeUpdate");
